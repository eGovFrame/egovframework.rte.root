 ...
 * </pre>
 */
public class EgovARIAEDcryptionBinServiceImpl implements EgovEDcryptionService {
    private static Logger logger  = CryptoLog.getLogger(EgovARIAEDcryptionBinServiceImpl.class);
    /** 복호화 시 사용 바이트 배열*/
    byte buf[] = null; 
    /** 암호화 결과 리턴 바이트 배열*/
    byte[] rt_buf = null;
    ...
    /**
     * EgovARIAEDcryptionBinServiceImpl 생성자
     */
    public EgovARIAEDcryptionBinServiceImpl()
    {
         ...
         // TODO Auto-generated method stub
           ...
           if(tmp_enc.equals(cinfo.getPassword().trim()))
          {
              try
                ...
                rtn_buf = egovCipherService.decrypt(buf);
    ...
    if(tmp_enc.equals(cinfo.getPassword().trim()))
     {
          ...
          rt_buf = egovCipherService.encrypt(buf);
          try
          {
           fos.write(rt_buf);
          }catch(IOException e)
