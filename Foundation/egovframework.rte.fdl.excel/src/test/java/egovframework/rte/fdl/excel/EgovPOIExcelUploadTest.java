...
@Transactional
public class EgovPOIExcelUploadTest extends
	...
	@Resource(name = "XSSFexcelBigService")
    private EgovExcelService excelBigService;
	
	private static final Log log = LogFactory.getLog(EgovPOIExcelUploadTest.class);
    ...
    public void testUploadExcelFile() throws Exception {
        ...
        try {
        	...
        	excelService.uploadXSSFExcel("insertEmpUsingBatch", fileIn);
    ...
    public void testBigUploadExcelFile() throws Exception {
        ...
        try {
        	...
        	excelBigService.uploadXSSFExcel("insertZipUsingBatch", fileIn, 2, (long)5000);
