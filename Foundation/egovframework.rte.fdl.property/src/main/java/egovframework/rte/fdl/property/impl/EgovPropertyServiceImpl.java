 ...
 * </pre>
 */
public class EgovPropertyServiceImpl implements EgovPropertyService,
        ...
        try {
            ...
            if (EgovPropertyService.LOGGER.isErrorEnabled()) {
                EgovPropertyService.LOGGER.error(messageSource.getMessage(
                    "error.properties.refresh.files", new String[] {fileName },
                    Locale.getDefault()));
                EgovPropertyService.LOGGER.error(messageSource.getMessage(
                    "error.properties.refresh.files.reason", new String[] {},
                    Locale.getDefault()));
            }
            throw new FdlException("error.properties.refresh.files",
        ...
        if (EgovPropertyService.LOGGER.isDebugEnabled()) {
            EgovPropertyService.LOGGER.debug(messageSource.getMessage(
                "debug.properties.filename", new String[] {
                    resource.getFilename(), encoding }, Locale.getDefault()));
        }
