...
public class EgovWebServiceContextTest
{
    ...
    private final OrganizationDefinition organizationA =
        new OrganizationDefinition("ORG00000", "Organization A");
    
    private final SystemDefinition systemA =
        new SystemDefinition("SYS00000", organizationA, "SYS00000", "System A", true);

    private final ServiceDefinition serviceA =
        new ServiceDefinition("SRV00000", systemA, "SRV00000", "Service A", "Req", "Res", "providerBean", true, true);
    
    private final OrganizationDefinition organizationB =
        new OrganizationDefinition("ORG00001", "Organization B");
    
    private final SystemDefinition systemB =
        new SystemDefinition("SYS00001", organizationB, "SYS00001", "System B", true);

    private final ServiceDefinition serviceB =
        new ServiceDefinition("SRV00001", systemB, "SRV00001", "Service B", "Req", "Res", "providerBean", true, true);
    
    private final IntegrationDefinition integrationDefinitionAtoB =
        new IntegrationDefinition("AtoB", serviceB, systemA, 5000, true, null, null);
        
    private final IntegrationDefinition integrationDefinitionBtoA =
        new IntegrationDefinition("BtoA", serviceA, systemB, 5000, true, null, null);
    
    private final RecordType recordTypeReq =
        new RecordType("Req", "Req");
    
    private final RecordType recordTypeRes =
        new RecordType("Res", "Res");
    
    private final WebServiceClientDefinition webServiceClientDefinitionA =
        new WebServiceClientDefinition("SRV00000", serviceA, "http://test/", "http://localhost/A/test?wsdl", "ServiceA", "PortA", "service", new HashMap<String, MappingInfo>(), new HashMap<String, MappingInfo>());
    
    private final WebServiceClientDefinition webServiceClientDefinitionB =
        new WebServiceClientDefinition("SRV00001", serviceB, "http://test/", "http://localhost/B/test?wsdl", "ServiceB", "PortB", "service", new HashMap<String, MappingInfo>(), new HashMap<String, MappingInfo>());

    private final WebServiceServerDefinition webServiceServerDefinitionA =
        new WebServiceServerDefinition("SRV00000", serviceA, "http://test/", "/A/test", "ServiceA", "PortA", "service");
    
    private final WebServiceServerDefinition webServiceServerDefinitionB =
        new WebServiceServerDefinition("SRV00001", serviceB, "http://test/", "/B/test", "ServiceB", "PortB", "service");
    
    private final EgovIntegrationServiceProvider providerBean =
        new EgovIntegrationServiceProvider()
    {
        public void service(EgovIntegrationMessage arg0,
                EgovIntegrationMessage arg1)
        {
        }
    };
        ...
        new EgovWebServiceClassLoader()
    {
        ...
        public Class<?> loadClass(ServiceEndpointInfo serviceEndpointInfo)
                throws ClassNotFoundException
        {
            if (serviceEndpointInfo.getServiceName().equals(
                    webServiceServerDefinitionA.getServiceName()))
            {
                return WebServiceServerA.class;
            }
            else if (serviceEndpointInfo.getServiceName().equals(
                    webServiceServerDefinitionB.getServiceName()))
            {
        ...
        public Class<?> loadClass(
                ...
                throws ClassNotFoundException
        {
            if (serviceEndpointInterfaceInfo.getServiceName().equals(
                    webServiceClientDefinitionA.getServiceName()))
            {
                return WebServiceClientA.class;
            }
            else if (serviceEndpointInterfaceInfo.getServiceName().equals(
                    webServiceClientDefinitionB.getServiceName()))
            {
    ...
    private IntegrationDefinitionDao integrationDefinitionDao =
        new IntegrationDefinitionDao()
    {
        @SuppressWarnings("serial")
        private final Map<String, IntegrationDefinition> map =
            new HashMap<String, IntegrationDefinition>()
            {{
        ...
        @SuppressWarnings("serial")
        private final List<IntegrationDefinition> consumerA =
            new ArrayList<IntegrationDefinition>()
            {{
                add(integrationDefinitionAtoB);
            }};
            
        @SuppressWarnings("serial")
        private final List<IntegrationDefinition> consumerB =
            new ArrayList<IntegrationDefinition>()
            {{
    ...
    private WebServiceClientDefinitionDao webServiceClientDefinitionDao =
        new WebServiceClientDefinitionDao()
    {
        @SuppressWarnings("serial")
        private Map<String, WebServiceClientDefinition> map =
            new HashMap<String, WebServiceClientDefinition>()
            {{
    ...
    private WebServiceServerDefinitionDao webServiceServerDefinitionDao =
        new WebServiceServerDefinitionDao()
    {
        @SuppressWarnings("serial")
        private Map<String, WebServiceServerDefinition> map =
            new HashMap<String, WebServiceServerDefinition>()
            {{
