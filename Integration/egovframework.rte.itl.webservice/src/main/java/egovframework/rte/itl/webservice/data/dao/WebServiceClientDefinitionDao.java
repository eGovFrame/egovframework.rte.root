 ...
 * <p>
 * <b>NOTE:</b> 전자정부 웹 서비스 설정 정보 중 Client 정보를 읽어오기 위한
...
public interface WebServiceClientDefinitionDao {
     ...
     * @param key
     *        서비스 key
     * @return WebServiceClientDefinition, 해당하는 값이 없을
     *         경우 <code>null</code>
     */
    ...
    /**
     * <code>serviceDefinition</code>의 <code>key</code>
     * 를 primary key로 갖는 WebServiceClientDefinition을
     * 읽어온다.
