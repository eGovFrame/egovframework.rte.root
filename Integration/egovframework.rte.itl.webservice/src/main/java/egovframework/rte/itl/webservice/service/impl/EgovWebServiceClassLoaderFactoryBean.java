 ...
 * <p>
 * <b>NOTE:</b> EgovWebServiceCalssLoader의 FactoryBean
 * class이다.
 * @author 실행환경 개발팀 심상호
 * @since 2009.06.01
 * @version 1.0
 ...
 * </pre>
 */
public class EgovWebServiceClassLoaderFactoryBean implements FactoryBean,
    ...
    private EgovWebServiceClassLoader createEgovWebServiceClassLoader() {
        if (applicationContext == null
            ...
            return new EgovWebServiceClassLoaderImpl(applicationContext
                .getClassLoader());
        }
    }
}
