 ...
 * <p>
 * <b>NOTE:</b> 전자정부 웹 서비스 설정 정보 중 Server 정보를 읽어오기 위한
 * Data Access Object interface이다.
 * @author 실행환경 개발팀 심상호
 * @since 2009.06.01
 * @version 1.0
 * @see <pre>
...
public interface WebServiceServerDefinitionDao {
     ...
     * @param key
     *        서비스 key
     * @return WebServiceServerDefinition, 해당하는 값이 없을
     *         경우 <code>null</code>
     */
    ...
    /**
     * <code>serviceDefinitino</code>의 <code>key</code>
     * 를 primary key로 갖는 WebServiceServerDefinition을
     * 읽어온다.
