...
public interface EgovWebServiceClassLoader {
    ...
    /**
     * ServiceInterface class의 ServiceBridge field
     * name을 return한다.
     ...
     *         <code>type</code>에 해당하는 Class를 생성할 수 없는
     *         경우
     */
    public Class<?> loadClass(final Type type) throws ClassNotFoundException;

    /**
     * <code>serviceEndpointInfo</code>에 해당하는 Service
     * Endpoint class를 load한다. Service Endpoint
     * Interface 및 Request/Response Message Type 역시 같이
     * load한다.
    ...
    /**
     * <code>serviceEndpointInterfaceInfo</code>에 해당하는
     * Service Endpoint Interface class를 load한다.
