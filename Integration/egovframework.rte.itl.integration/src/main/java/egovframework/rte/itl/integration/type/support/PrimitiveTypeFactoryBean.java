 ...
 * <p>
 * <b>NOTE:</b> 전자정부 연계 서비스의 표준 메시지의 PrimitiveType을
 * Spring Context 설정을 통해 reference할 수 있도록 지원하는
 * FactoryBean Class이다.
 * @author 실행환경 개발팀 심상호
 * @since 2009.06.01
 * @version 1.0
 ...
 * </pre>
 */
public class PrimitiveTypeFactoryBean extends AbstractFactoryBean implements
        BeanNameAware {
    /** bean name */
