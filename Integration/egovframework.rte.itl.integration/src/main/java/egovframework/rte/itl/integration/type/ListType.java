 ...
 * <p>
 * <b>NOTE:</b> 전자정부 연계 서비스의 표준 메시지를 정의하기 위한 Class이다.
 * Colleciton Type 중 List Type을 정의하기 위한 Class이다. List
 * Type은 한 종류의 Type만을 담을 수 있다.
 * @author 실행환경 개발팀 심상호
 * @since 2009.06.01
 * @version 1.0
 * @see <pre>
...
public class ListType extends AbstractType {
    ...
    protected static final Class<?>[] listTypeAssignableClasses =
        new Class<?>[] {TypedList.class, Collection.class };
    ...
    /**
     * <code>id</code>와 <code>elementType</code>를 가진
     * ListType을 생성한다.
     * @param id
     *        Type Id
     * @param name
    ...
    public boolean isAssignableValue(Object source) {
        ...
        if (source.getClass().isArray()) {
            return elementType.isAssignableFrom(source.getClass()
                .getComponentType());
        }
        return false;
    }
