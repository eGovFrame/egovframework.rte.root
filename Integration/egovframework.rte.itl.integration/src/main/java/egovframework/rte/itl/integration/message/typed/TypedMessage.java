 ...
 * <p>
 * <b>NOTE:</b> 전자정부 연계 서비스의 표준 Message interface를 구현한
 * Message class이다.
 * @author 실행환경 개발팀 심상호
 * @since 2009.06.01
 * @version 1.0
 ...
 * </pre>
 */
public final class TypedMessage extends TypedMap implements
    ...
    /**
     * <code>bodyType</code>을 바디부의 Type으로 갖는
     * TypedMessage를 생성한다.
     * @param bodyType
     *        바디부의 Type
     * @throws IllegalArgumentException
     *         Argument <code>bodyType</code> 값이
     *         <code>null</code>인 경우
     */
