 ...
 * Class이다. List Type에 해당하는 List Instance를 나타낸다.
 * @author 실행환경 개발팀 심상호
 * @since 2009.06.01
 * @version 1.0
 * @see <pre>
...
public class TypedList implements List<Object> {
    ...
    /**
     * Argument <code>type</code>에 해당하는 TypedList
     * Instance를 생성한다.
     * @param type
     *        type
    ...
    /**
     * Argument <code>type</code>에 해당하는 TypedList
     * Instance를 생성한다. Argument <code>collection</code>
     * 에 있는 값을 저장한다.
     * @param type
     *        type
     * @param collection
     *        collection
     * @throws IllegalArgumentException
     *         1. Argument <code>type</code> 값이
     *         <code>null</code>인 경우 2. Argument
     *         <code>collection</code> 값이 null인 경우
     */
    public TypedList(final ListType type,
    ...
    /**
     * Argument <code>type</code>에 해당하는 TypedList
     * Instance를 생성한다. Argument <code>array</code>에 있는
     * 값을 저장한다.
     * @param type
     *        type
     * @param array
     ...
     *         1. Argument <code>type</code> 값이
     *         <code>null</code>인 경우 2. Argument
     *         <code>array</code> 값이 <code>null</code>
     *         이거나 array가 아닌 경우
     */
    ...
    /**
     * Argument <code>value</code>를 TypedList에 담을 수 있는
     * 형태로 변환한다.
     * @param value
     *        value
     * @return 변환된 value
    ...
    /**
     * Argument <code>c</code>에 담겨있는 값들을 TypedList에 담을
     * 수 있는 형태로 변환한다.
     * @param c
     *        값을 담고 있는 Collection 객체
     * @return 변환된 값을 담고 있는 Collection 객체
     */
    protected Collection<Object> convertToTypedObjects(
