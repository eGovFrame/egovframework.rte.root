 ...
 * <p>
 * <b>NOTE:</b> 전자정부 연계 서비스의 표준 메시지를 정의하기 위한 Class 이다.
 * Colleciton Type 중 Record Type을 정의하기 위한 Class이다.
 * Record Type은 {@literal <key, value>}쌍의 값을 가질 수 있다.
 * @author 실행환경 개발팀 심상호
 * @since 2009.06.01
 * @version 1.0
 * @see <pre>
...
public class RecordType extends AbstractType {
    ...
    protected static final Class<?>[] recordTypeAssignableClasses =
        new Class<?>[] {TypedMap.class, Map.class };
    ...
    /**
     * Argument <code>id</code>를 id로 갖는 RecordType을
     * 생성한다.<br>
     * TypeLoader에서만 사용된다.
     * @param id
     *        id
     ...
     *         <code>null</code>이거나, 공백 문자로만 이루어진 경우
     */
    ...
    /**
     * <code>id</code>와 <code>fieldTypes</code>를 갖는
     * RecordType을 생성한다.
     * @param id
     *        id
     * @param fieldTypes
    ...
    public RecordType(final String id, final String name,
        ...
        super(id, name, recordTypeAssignableClasses);
        if (fieldTypes == null) {
            LOG.error("Argument 'fieldTypes' is null");
     ...
     * @throws <code>fieldTypes</code> 값이
     *         <code>null</code>인 경우
     */
     ...
     * @param fieldName
     *        Field 명
     * @return <code>fieldName</code>로 정의되어 있는 Field의
     *         Type
