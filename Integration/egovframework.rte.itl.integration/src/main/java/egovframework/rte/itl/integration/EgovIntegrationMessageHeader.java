...
public interface EgovIntegrationMessageHeader {
     ...
     * <p>
     * <b>Description</b> : 전자정부 연계 서비스 결과 코드를 나타내는
     * enum이다.
     * <p>
     * <table border="1">
     * <caption><b>Modification
	 ...
	 * <p>
	 * <b>NOTE:</b> 전자정부 연계 서비스 결과 코드를 나타내는 enum이다.
	 * @author 실행환경 개발팀 심상호
	 * @since 2009.06.01
	 * @version 1.0
	 * @see <pre>
    ...
    public enum ResultCode {
        ...
        /**
         * 사용하지 않는 연계 : <br>
         * 연계 정의(IntegrationDefinition)의
         * <code>using</code> flag가 <code>false</code>인
         * 경우
         */
        ...
        /**
         * 연계 가용시간이 아님 : <br>
         * 연계를 요청한 시각이 연계 정의(IntegrationDefinition)의
         * <code>validateFrom</code>와
         * <code>validateTo</code> 사이가 아닌 경우
         * <p>
         * <table border="1">
         * <caption> <b> 연계 가용시각 조건 (
         * <code>now : Calendar</code> = 현재 시각) </b>
         * </caption>
         * <tr bgcolor="bbbbbb">
        ...
        /**
         * 사용하지 않는 서비스 : <br>
         * 연계 정의(IntegrationDefinition)에 등록된 제공
         * 서비스(ServiceDefinition)의 <code>using</code>
         * flag 값이 <code>false</code>인 경우
         */
        NOT_USABLE_SERVICE("1002"),

        /**
         * 기대하지 않은 연계 요청자 : <br>
         * 연계 제공 시스템(Server)에 등록된 연계
         * 정의(IntegrationDefinition)의 요청 시스템 코드값과 요청
        ...
        /**
         * 기대하지 않은 연계 제공자 : <br>
         * 연계 제공 시스템(Server)에 등록된 시스템 코드와 요청 메시지 헤더의 제공
         * 시스템 코드값이 일치하지 않는 경우
         */
        ...
        /**
         * <code>value</code> 값에 해당하는 ResultCode를
         * return한다.
         * @param value
         *        value
         * @return ResultCode
