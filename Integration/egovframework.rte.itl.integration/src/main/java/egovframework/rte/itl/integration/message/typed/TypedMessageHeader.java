 ...
 * <p>
 * <b>NOTE:</b> 전자정부 연계 서비스의 표준 MessageHeader
 * interface를 구현한 MessageHeader class이다.
 * @author 실행환경 개발팀 심상호
 * @since 2009.06.01
 * @version 1.0
 * @see <pre>
 ...
 * </pre>
 */
public final class TypedMessageHeader extends TypedMap implements
        EgovIntegrationMessageHeader {
    /** 연계 Id */
    public static final String INTEGRATION_ID = "__integrationId__";

    /** 제공 기관 Id */
    public static final String PROVIDER_ORGANIZATION_ID =
        "__providerOrganizationId__";
    ...
    /** 요청 기관 Id */
    public static final String CONSUMER_ORGANIZATION_ID =
        "__consumerOrganizationId__";
    ...
    /** 응답 수신 시각 */
    public static final String RESPONSE_RECEIVE_TIME =
        "__responseReceiveTime__";
    ...
    public static final RecordType TYPE =
        new RecordType(TYPE_ID, TYPE_NAME, new HashMap<String, Type>() {
            {
     ...
     *        결과 메시지
     */
    public TypedMessageHeader(String integrationId,
