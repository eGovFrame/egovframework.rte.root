...
public class TypedMapTest
{
    ...
    private static final RecordType recordType =
        new RecordType("recordA", "RecordA",
    ...
    public void testContainsValue() throws Exception
    {
        ...
        assertTrue(map.containsValue(
                new TypedList(stringListType, stringArray)));
    ...
    public void testEntrySet() throws Exception
    {
        ...
        for (Entry<String, Object> entry : entrySet)
        {
            ...
            {
                assertEquals(new TypedList(stringListType, stringArray),
                        entry.getValue());
            }
        }
    }
