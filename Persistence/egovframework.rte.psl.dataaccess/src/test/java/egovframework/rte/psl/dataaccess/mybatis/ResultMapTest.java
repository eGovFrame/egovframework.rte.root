...
public class ResultMapTest extends TestBase {
    ...
    public void testExtendsResultMapSelect() throws Exception {
        ...
        EmpExtendsDeptVO resultVO =
            empMapper.selectEmpExtendsDept("egovframework.rte.psl.dataaccess.EmpMapper.selectEmpExtendsDeptUsingResultMap",
                vo);
    ...
    public void testSimpleCompositeResultMapSelect() throws Exception {
        ...
        EmpDeptSimpleCompositeVO resultVO =
            empMapper.selectEmpDeptSimpleComposite(
                "egovframework.rte.psl.dataaccess.EmpMapper.selectEmpDeptSimpleCompositeUsingResultMap", vo);
