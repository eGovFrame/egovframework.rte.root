...
public class EmpDAO extends EgovAbstractDAO {
    ...
    public EmpExtendsDeptVO selectEmpExtendsDept(String queryId, EmpVO vo) {
        return (EmpExtendsDeptVO) getSqlMapClientTemplate().queryForObject(
            queryId, vo);
    }

    public EmpDeptSimpleCompositeVO selectEmpDeptSimpleComposite(
            String queryId, EmpVO vo) {
        return (EmpDeptSimpleCompositeVO) getSqlMapClientTemplate()
            .queryForObject(queryId, vo);
    }

    public EmpIncludesDeptVO selectEmpDeptComplexProperties(String queryId,
            EmpVO vo) {
        return (EmpIncludesDeptVO) getSqlMapClientTemplate().queryForObject(
            queryId, vo);
    }

    public DeptIncludesEmpListVO selectDeptEmpListComplexProperties(
            String queryId, DeptVO vo) {
        return (DeptIncludesEmpListVO) getSqlMapClientTemplate()
            .queryForObject(queryId, vo);
    }

    @SuppressWarnings("unchecked")
    public List<DeptIncludesEmpListVO> selectDeptEmpListComplexPropertiesList(
            String queryId, DeptVO vo) {
        return getSqlMapClientTemplate().queryForList(queryId, vo);
    }

    public EmpIncludesMgrVO selectEmpMgrHierarchy(String queryId, EmpVO vo) {
        return (EmpIncludesMgrVO) getSqlMapClientTemplate().queryForObject(
            queryId, vo);
    }

    public EmpIncludesEmpListVO selectEmpIncludesEmpList(String queryId,
            EmpVO vo) {
        return (EmpIncludesEmpListVO) getSqlMapClientTemplate().queryForObject(
            queryId, vo);
    }
    //
    // @SuppressWarnings("unchecked")
    // public List<EmpVO> selectEmpList(String queryId,
    // EmpVO searchVO) {
    // return
    // getSqlMapClientTemplate().queryForList(queryId,
    // searchVO);
    // }
}
