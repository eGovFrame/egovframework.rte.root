...
public class CalendarMapperTypeHandler implements TypeHandler<Calendar> {
	...
	public void setParameter(PreparedStatement ps, int i, Calendar parameter,
	...
	public Calendar getResult(ResultSet rs, int columnIndex)
			throws SQLException {
	...
	public Calendar getResult(CallableStatement cs, int columnIndex)
			throws SQLException {
